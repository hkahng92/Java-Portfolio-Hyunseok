...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<VndErrors> dataAccessException(DataAccessException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), "The number value(s) you have entered is too big.");
        ResponseEntity<VndErrors> responseEntity = new ResponseEntity<>(error, HttpStatus.UNPROCESSABLE_ENTITY);
        return responseEntity;
    }
    ...
    @ExceptionHandler(value = {QuantityValidationException.class})
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public ResponseEntity<VndErrors> quantityValidationException(QuantityValidationException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), e.getMessage());
    ...
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public ResponseEntity<VndErrors> invalidItemTypeException(InvalidItemTypeException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), e.getMessage());
        ResponseEntity<VndErrors> responseEntity = new ResponseEntity<>(error, HttpStatus.NOT_ACCEPTABLE);
        return responseEntity;
    }
